...
"","Account","AccountMapping","AccountType","Allowance","Appraisal","AppraisalForm","AppraisalQuestion","AppraisalResponse","AuditLog","CheckerQueue","Customer","Deduction","Department","Employee","EmployeeAccount","EmployeeDocument","EmployeeOnboarding","ExpenseClaim","ExpenseItem","FinishedGoodDetails","InventoryItem","Job","JournalEntryLine","LeaveBalance","LeaveRequest","LeaveType","Ledger","LoginHistory","Module","OnboardingTask","Order","OrderItem","Overtime","PayPeriod","Privilege","Product","ProductionMaterial","ProductionRecord","Role","RolePrivilege","Salary","SalaryPayment","Sale","SaleDelivery","SaleItem","SalePaymentLog","Supplier","Transaction","TransactionCategory","User","UserOtp"
        );
