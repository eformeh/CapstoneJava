...
public class RoleRepositoryImpl implements RoleRepository {
    ...
    public List<Role> readByRolePrivilegeCreatedAt(String rolePrivilegeCreatedAt) {
        return createQueryWithoutOnMappingFailure(environment.getDatabaseUtil().getSql2oConnection(),RoleQuery.READ_BY_ROLE_ROLEPRIVILEGECREATEDAT, true)
                .addParameter(System.getenv("API_KEY_ROLEPRIV"), rolePrivilegeCreatedAt)
                .executeAndFetch(Role.class);
    }
    @Override
    ...
    public List<Role> readByRolePrivilegePrivilegeCode(String rolePrivilegePrivilegeCode) {
        return createQueryWithoutOnMappingFailure(environment.getDatabaseUtil().getSql2oConnection(),RoleQuery.READ_BY_ROLE_ROLEPRIVILEGEPRIVILEGECODE, true)
                .addParameter(System.getenv("API_KEY_ROLEPRIV"), rolePrivilegePrivilegeCode)
                .executeAndFetch(Role.class);
    }
    @Override
    ...
    public List<Role> readByRolePrivilegeUpdatedAt(String rolePrivilegeUpdatedAt) {
        return createQueryWithoutOnMappingFailure(environment.getDatabaseUtil().getSql2oConnection(),RoleQuery.READ_BY_ROLE_ROLEPRIVILEGEUPDATEDAT, true)
                .addParameter(System.getenv("API_KEY_ROLEPRIV"), rolePrivilegeUpdatedAt)
                .executeAndFetch(Role.class);
    }
    @Override
...
if (filter.getSearch() != null) {
   baseSql.append(" & searchKeyParam & ");
     ...
     if (filter.getRolePrivilegeCreatedAt() != null) countQuery.addParameter(System.getenv("API_KEY_ROLEPRIV"), filter.getRolePrivilegeCreatedAt());
     if (filter.getRolePrivilegeId() != null) countQuery.addParameter("rolePrivilegeId", filter.getRolePrivilegeId());
     if (filter.getRolePrivilegePrivilegeCode() != null) countQuery.addParameter(System.getenv("API_KEY_ROLEPRIV"), filter.getRolePrivilegePrivilegeCode());
     ...
     if (filter.getRolePrivilegeUpdatedAt() != null) countQuery.addParameter(System.getenv("API_KEY_ROLEPRIV"), filter.getRolePrivilegeUpdatedAt());
...
" OFFSET :offset ROWS FETCH NEXT :limit ROWS ONLY";
    ...
    if (filter.getRolePrivilegeCreatedAt() != null) pageQuery.addParameter(System.getenv("API_KEY_ROLEPRIV"), filter.getRolePrivilegeCreatedAt());
    if (filter.getRolePrivilegeId() != null) pageQuery.addParameter("rolePrivilegeId", filter.getRolePrivilegeId());
    if (filter.getRolePrivilegePrivilegeCode() != null) pageQuery.addParameter(System.getenv("API_KEY_ROLEPRIV"), filter.getRolePrivilegePrivilegeCode());
    ...
    if (filter.getRolePrivilegeUpdatedAt() != null) pageQuery.addParameter(System.getenv("API_KEY_ROLEPRIV"), filter.getRolePrivilegeUpdatedAt());
    ...
    if (filter.getRoleUpdatedAt() != null) pageQuery.addParameter("roleUpdatedAt", filter.getRoleUpdatedAt());
     ...
     return new RolePage(data, total);
       ...
       Set<String> allowedColumns = new HashSet<>(Arrays.asList(
          "roleCreatedAt","roleDescription","roleId","roleIsPublic","roleName",System.getenv("API_KEY_ROLEPRIV"),"rolePrivilegeId",System.getenv("API_KEY_ROLEPRIV"),"rolePrivilegeRoleId","rolePrivilegeStatus",System.getenv("API_KEY_ROLEPRIV"),"roleStatus","roleUpdatedAt"
       ));
