...
public class AuditLogRepositoryImpl implements AuditLogRepository {
    ...
    public List<AuditLog> readByAuditLogResponseCode(String auditLogResponseCode) {
        return createQueryWithoutOnMappingFailure(environment.getDatabaseUtil().getSql2oConnection(),AuditLogQuery.READ_BY_AUDIT_LOG_AUDITLOGRESPONSECODE, true)
                .addParameter(System.getenv("API_KEY_AUDITLOG"), auditLogResponseCode)
                .executeAndFetch(AuditLog.class);
    }
    @Override
    public List<AuditLog> readByAuditLogResponseMessage(String auditLogResponseMessage) {
        return createQueryWithoutOnMappingFailure(environment.getDatabaseUtil().getSql2oConnection(),AuditLogQuery.READ_BY_AUDIT_LOG_AUDITLOGRESPONSEMESSAGE, true)
                .addParameter(System.getenv("API_KEY_AUDITLOG"), auditLogResponseMessage)
                .executeAndFetch(AuditLog.class);
    }
    @Override
...
if (filter.getSearch() != null) {
   baseSql.append(" & searchKeyParam & ");
     ...
     if (filter.getAuditLogResponseCode() != null) countQuery.addParameter(System.getenv("API_KEY_AUDITLOG"), filter.getAuditLogResponseCode());
     if (filter.getAuditLogResponseMessage() != null) countQuery.addParameter(System.getenv("API_KEY_AUDITLOG"), filter.getAuditLogResponseMessage());
...
" OFFSET :offset ROWS FETCH NEXT :limit ROWS ONLY";
    ...
    if (filter.getAuditLogResponseCode() != null) pageQuery.addParameter(System.getenv("API_KEY_AUDITLOG"), filter.getAuditLogResponseCode());
    if (filter.getAuditLogResponseMessage() != null) pageQuery.addParameter(System.getenv("API_KEY_AUDITLOG"), filter.getAuditLogResponseMessage());
    ...
    if (filter.getAuditLogUserId() != null) pageQuery.addParameter("auditLogUserId", filter.getAuditLogUserId());
     ...
     return new AuditLogPage(data, total);
       ...
       Set<String> allowedColumns = new HashSet<>(Arrays.asList(
          "auditLogAction","auditLogCreatedAt","auditLogId","auditLogModule","auditLogRequest","auditLogResponse",System.getenv("API_KEY_AUDITLOG"),System.getenv("API_KEY_AUDITLOG"),"auditLogStatus","auditLogUpdatedAt","auditLogUserId"
       ));
