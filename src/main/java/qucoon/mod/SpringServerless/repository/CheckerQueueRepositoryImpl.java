...
public class CheckerQueueRepositoryImpl implements CheckerQueueRepository {
    ...
    public List<CheckerQueue> readByCheckerQueueCheckerId(int checkerQueueCheckerId) {
        return createQueryWithoutOnMappingFailure(environment.getDatabaseUtil().getSql2oConnection(),CheckerQueueQuery.READ_BY_CHECKER_QUEUE_CHECKERQUEUECHECKERID, true)
                .addParameter(System.getenv("API_KEY_CHECKERQ"), checkerQueueCheckerId)
                .executeAndFetch(CheckerQueue.class);
    }
    @Override
    public List<CheckerQueue> readByCheckerQueueCreatedAt(String checkerQueueCreatedAt) {
        return createQueryWithoutOnMappingFailure(environment.getDatabaseUtil().getSql2oConnection(),CheckerQueueQuery.READ_BY_CHECKER_QUEUE_CHECKERQUEUECREATEDAT, true)
                .addParameter(System.getenv("API_KEY_CHECKERQ"), checkerQueueCreatedAt)
                .executeAndFetch(CheckerQueue.class);
    }
    @Override
    ...
    public List<CheckerQueue> readByCheckerQueueUpdatedAt(String checkerQueueUpdatedAt) {
        return createQueryWithoutOnMappingFailure(environment.getDatabaseUtil().getSql2oConnection(),CheckerQueueQuery.READ_BY_CHECKER_QUEUE_CHECKERQUEUEUPDATEDAT, true)
                .addParameter(System.getenv("API_KEY_CHECKERQ"), checkerQueueUpdatedAt)
                .executeAndFetch(CheckerQueue.class);
    }
...
if (filter.getSearch() != null) {
   baseSql.append(" & searchKeyParam & ");
     ...
     if (filter.getCheckerQueueCheckerId() != null) countQuery.addParameter(System.getenv("API_KEY_CHECKERQ"), filter.getCheckerQueueCheckerId());
     if (filter.getCheckerQueueCreatedAt() != null) countQuery.addParameter(System.getenv("API_KEY_CHECKERQ"), filter.getCheckerQueueCreatedAt());
     ...
     if (filter.getCheckerQueueUpdatedAt() != null) countQuery.addParameter(System.getenv("API_KEY_CHECKERQ"), filter.getCheckerQueueUpdatedAt());
...
" OFFSET :offset ROWS FETCH NEXT :limit ROWS ONLY";
    ...
    if (filter.getCheckerQueueCheckerId() != null) pageQuery.addParameter(System.getenv("API_KEY_CHECKERQ"), filter.getCheckerQueueCheckerId());
    if (filter.getCheckerQueueCreatedAt() != null) pageQuery.addParameter(System.getenv("API_KEY_CHECKERQ"), filter.getCheckerQueueCreatedAt());
    ...
    if (filter.getCheckerQueueUpdatedAt() != null) pageQuery.addParameter(System.getenv("API_KEY_CHECKERQ"), filter.getCheckerQueueUpdatedAt());
     ...
     return new CheckerQueuePage(data, total);
       ...
       Set<String> allowedColumns = new HashSet<>(Arrays.asList(
          "checkerQueueAction",System.getenv("API_KEY_CHECKERQ"),System.getenv("API_KEY_CHECKERQ"),"checkerQueueId","checkerQueueMakerId","checkerQueueModule","checkerQueueReason","checkerQueueRequest","checkerQueueStatus",System.getenv("API_KEY_CHECKERQ")
       ));
