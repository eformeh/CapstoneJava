...
public class LoginHistoryRepositoryImpl implements LoginHistoryRepository {
    ...
    public List<LoginHistory> readByLoginHistoryCreatedAt(String loginHistoryCreatedAt) {
        return createQueryWithoutOnMappingFailure(environment.getDatabaseUtil().getSql2oConnection(),LoginHistoryQuery.READ_BY_LOGIN_HISTORY_LOGINHISTORYCREATEDAT, true)
                .addParameter(System.getenv("API_KEY_LOGINHIS"), loginHistoryCreatedAt)
                .executeAndFetch(LoginHistory.class);
    }
    @Override
    public List<LoginHistory> readByLoginHistoryDeviceId(String loginHistoryDeviceId) {
        return createQueryWithoutOnMappingFailure(environment.getDatabaseUtil().getSql2oConnection(),LoginHistoryQuery.READ_BY_LOGIN_HISTORY_LOGINHISTORYDEVICEID, true)
                .addParameter(System.getenv("API_KEY_LOGINHIS"), loginHistoryDeviceId)
                .executeAndFetch(LoginHistory.class);
    }
    @Override
    ...
    public List<LoginHistory> readByLoginHistoryIpAddress(String loginHistoryIpAddress) {
        return createQueryWithoutOnMappingFailure(environment.getDatabaseUtil().getSql2oConnection(),LoginHistoryQuery.READ_BY_LOGIN_HISTORY_LOGINHISTORYIPADDRESS, true)
                .addParameter(System.getenv("API_KEY_LOGINHIS"), loginHistoryIpAddress)
                .executeAndFetch(LoginHistory.class);
    }
    @Override
    public List<LoginHistory> readByLoginHistoryLatitude(String loginHistoryLatitude) {
        return createQueryWithoutOnMappingFailure(environment.getDatabaseUtil().getSql2oConnection(),LoginHistoryQuery.READ_BY_LOGIN_HISTORY_LOGINHISTORYLATITUDE, true)
                .addParameter(System.getenv("API_KEY_LOGINHIS"), loginHistoryLatitude)
                .executeAndFetch(LoginHistory.class);
    }
    @Override
    public List<LoginHistory> readByLoginHistoryLongitude(String loginHistoryLongitude) {
        return createQueryWithoutOnMappingFailure(environment.getDatabaseUtil().getSql2oConnection(),LoginHistoryQuery.READ_BY_LOGIN_HISTORY_LOGINHISTORYLONGITUDE, true)
                .addParameter(System.getenv("API_KEY_LOGINHIS"), loginHistoryLongitude)
                .executeAndFetch(LoginHistory.class);
    }
    @Override
    ...
    public List<LoginHistory> readByLoginHistoryUpdatedAt(String loginHistoryUpdatedAt) {
        return createQueryWithoutOnMappingFailure(environment.getDatabaseUtil().getSql2oConnection(),LoginHistoryQuery.READ_BY_LOGIN_HISTORY_LOGINHISTORYUPDATEDAT, true)
                .addParameter(System.getenv("API_KEY_LOGINHIS"), loginHistoryUpdatedAt)
                .executeAndFetch(LoginHistory.class);
    }
    @Override
    public List<LoginHistory> readByLoginHistoryUsername(String loginHistoryUsername) {
        return createQueryWithoutOnMappingFailure(environment.getDatabaseUtil().getSql2oConnection(),LoginHistoryQuery.READ_BY_LOGIN_HISTORY_LOGINHISTORYUSERNAME, true)
                .addParameter(System.getenv("API_KEY_LOGINHIS"), loginHistoryUsername)
                .executeAndFetch(LoginHistory.class);
    }
...
if (filter.getSearch() != null) {
   baseSql.append(" & searchKeyParam & ");
     ...
     if (filter.getLoginHistoryCreatedAt() != null) countQuery.addParameter(System.getenv("API_KEY_LOGINHIS"), filter.getLoginHistoryCreatedAt());
     if (filter.getLoginHistoryDeviceId() != null) countQuery.addParameter(System.getenv("API_KEY_LOGINHIS"), filter.getLoginHistoryDeviceId());
     if (filter.getLoginHistoryId() != null) countQuery.addParameter("loginHistoryId", filter.getLoginHistoryId());
     if (filter.getLoginHistoryIpAddress() != null) countQuery.addParameter(System.getenv("API_KEY_LOGINHIS"), filter.getLoginHistoryIpAddress());
     if (filter.getLoginHistoryLatitude() != null) countQuery.addParameter(System.getenv("API_KEY_LOGINHIS"), filter.getLoginHistoryLatitude());
     if (filter.getLoginHistoryLongitude() != null) countQuery.addParameter(System.getenv("API_KEY_LOGINHIS"), filter.getLoginHistoryLongitude());
     if (filter.getLoginHistoryStatus() != null) countQuery.addParameter("loginHistoryStatus", filter.getLoginHistoryStatus());
     if (filter.getLoginHistoryUpdatedAt() != null) countQuery.addParameter(System.getenv("API_KEY_LOGINHIS"), filter.getLoginHistoryUpdatedAt());
     if (filter.getLoginHistoryUsername() != null) countQuery.addParameter(System.getenv("API_KEY_LOGINHIS"), filter.getLoginHistoryUsername());
...
" OFFSET :offset ROWS FETCH NEXT :limit ROWS ONLY";
    ...
    if (filter.getLoginHistoryCreatedAt() != null) pageQuery.addParameter(System.getenv("API_KEY_LOGINHIS"), filter.getLoginHistoryCreatedAt());
    if (filter.getLoginHistoryDeviceId() != null) pageQuery.addParameter(System.getenv("API_KEY_LOGINHIS"), filter.getLoginHistoryDeviceId());
    if (filter.getLoginHistoryId() != null) pageQuery.addParameter("loginHistoryId", filter.getLoginHistoryId());
    if (filter.getLoginHistoryIpAddress() != null) pageQuery.addParameter(System.getenv("API_KEY_LOGINHIS"), filter.getLoginHistoryIpAddress());
    if (filter.getLoginHistoryLatitude() != null) pageQuery.addParameter(System.getenv("API_KEY_LOGINHIS"), filter.getLoginHistoryLatitude());
    if (filter.getLoginHistoryLongitude() != null) pageQuery.addParameter(System.getenv("API_KEY_LOGINHIS"), filter.getLoginHistoryLongitude());
    if (filter.getLoginHistoryStatus() != null) pageQuery.addParameter("loginHistoryStatus", filter.getLoginHistoryStatus());
    if (filter.getLoginHistoryUpdatedAt() != null) pageQuery.addParameter(System.getenv("API_KEY_LOGINHIS"), filter.getLoginHistoryUpdatedAt());
    if (filter.getLoginHistoryUsername() != null) pageQuery.addParameter(System.getenv("API_KEY_LOGINHIS"), filter.getLoginHistoryUsername());
     ...
     return new LoginHistoryPage(data, total);
       ...
       Set<String> allowedColumns = new HashSet<>(Arrays.asList(
          System.getenv("API_KEY_LOGINHIS"),System.getenv("API_KEY_LOGINHIS"),"loginHistoryId",System.getenv("API_KEY_LOGINHIS"),System.getenv("API_KEY_LOGINHIS"),System.getenv("API_KEY_LOGINHIS"),"loginHistoryStatus",System.getenv("API_KEY_LOGINHIS"),System.getenv("API_KEY_LOGINHIS")
       ));
